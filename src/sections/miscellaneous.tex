...
\begin{prop}
	...
	Let $(W,S)$ be a Coxeter system and $K,T,S_1,S_2,S_3$ be like in \quesref{main}. Suppose we have $w \in W$ and $a_1,\ldots,a_n \in T \cup S_1$, $b_1,\ldots,b_n \in T \cup S_2$, $c_1,\ldots,c_n \in T \cup S_3$ with
	\begin{align*}
