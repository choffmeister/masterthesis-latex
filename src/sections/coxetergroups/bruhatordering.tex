...
\begin{prop}[Lifting Property]
	%\cite[Theorem 1.1]{deodhar:bruhat-order}
	\namedlabel{prop:lifting-property}
	...
	\begin{proof}
		See \cite[Theorem 1.1]{deodhar:bruhat-order}. \todo
	\end{proof}
\end{prop}

The \ref{prop:lifting-property} seems quite innocent, but when trying to investigate facts around the Bruhat ordering it proofs to be one of the key tools in many cases.