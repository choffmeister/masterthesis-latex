...
\begin{lemm}
	\typedlabel{lemm:rank-2-residuums-are-convex} Let $(W,S)$ be a Coxeter system, $w \in W$ and $s,t \in S$ two distinct generators. Then $wC_{\{s,t\}}$ does not contain three elements of same twisted length.
