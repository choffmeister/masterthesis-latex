...
\begin{lemm}[Lifting property for $\ul S$]
	...
	\begin{proof}
		We distinguish between the four cases of one- and bothsided action of $s$ on $u$ and $w$. Whenever a relation comes from the ordinary \ref{theo:lifting-property}, we denote it with $<_{LP}$ in this proof.
		\begin{description}
