...
A remarkable property of the action from \ref{defi:twisted-operation} is its $e$-orbit. As the following lemma will show that it coincides with $\ti{\theta}$.
...
\begin{exam}
	Let $w \in W$. Then $wC_\emptyset = \{ w \}$ and $wC_S = W$.
\end{exam}
