...
\begin{exam}
	...
	Let $\theta$ be a automorphism of $W \times W$ with $\theta : (u,w) \mapsto (w,u)$. Then $\theta$ is a Coxeter system automorphism of the Coxeter system $(W \times W, S \times S)$ and the set of twisted involutions is
...
\begin{lemm}
	...
	\begin{proof}
		\proofcite{Lemma 3.8}{hultman:comb-twisted-invo}
...
\begin{prop}[Exchange property for twisted expressions]
	...
	\begin{proof}
		\proofcite{Proposition 3.10}{hultman:comb-twisted-invo}
