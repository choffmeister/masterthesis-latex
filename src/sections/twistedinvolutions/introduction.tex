...
A remarkable property of the operation from \ref{defi:twisted-operation} (and the main reason why we are interested in it) is its $e$-orbit. As the following lemma will show it coincides with $\ti{\theta}$.
