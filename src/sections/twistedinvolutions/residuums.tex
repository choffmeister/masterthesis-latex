...
\begin{coro}
	...
	Let $w \in S$ and let $s,t \in S$ be two distinct generators. If $w$ is neither the unique element in $wC_{\{s,t\}}$ of smallest twisted length nor the unique (but not necessarily existing) element of largest twisted length, then $s$ and $t$ act twosided on $w$.
