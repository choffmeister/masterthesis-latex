...
\begin{exam}
	In Figure \ref{fig:d4_s1s2-and-d4_s3s4} we see Hasse diagram of $Wk(\id)$ on the involutions in the Coxeter group $D_4$. Solid edges represent bothsided actions and dashed edges represent onesided actions.
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.3\textwidth]{resources/d4_s1s2}
		\quad \quad \quad
		\includegraphics[width=0.3\textwidth]{resources/d4_s3s4}
		\caption{Hasse diagrams of $Wk(\id), W = D_4$ with only $s_1,s_2$ edges on the left and only $s_3,s_4$ edges on the right side}
