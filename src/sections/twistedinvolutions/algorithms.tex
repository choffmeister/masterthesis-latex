...
For all runtime investigations in the paper, we consider $|S|$ to be constant (this is suitable, since $|S|$ is tiny compared to $|\ti{\theta}|$). 
...
\begin{algo}[TWOA1]
	...
	\begin{algorithmic}[1]
	\Procedure{CheckIfAlreadyKnown}{$(W,S),w,s,V$}
		\State $y \gets ws$
