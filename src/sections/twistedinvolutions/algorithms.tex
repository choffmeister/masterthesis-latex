...
\begin{lemm}
	...
	\end{align*}
	Note that $a,b,c,d \in \{0,1\}$ contain the information, if edges next to the minimal and the maximal element of $wC_{\{s,t\}}$ are one- or bothsided. Then $a = (b+c+d) \mod 2$.
