...
sehr aufwendige Operation. Bei \algoref{algo:twoa1} muss jedes
...
%TODO translate
Im Anhang findet sich eine Implementierung der \algoref{algo:twoa1,algo:twoa2}
in GAP 4.5.4. \tableref{tab:benchmark-twoa} zeigt ein Benchmark anhand von fünf
