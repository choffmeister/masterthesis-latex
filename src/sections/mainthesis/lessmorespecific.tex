...
\begin{theo}
	...
	\begin{proof}
		...
		\end{align*}
		Let $w_K = \ul s'_1 \ldots \ul s'_m \ul s''_1 \ldots \ul s''_{m'}$ with $s'_i \in K',s''_i \in K''$. We have three twisted expressions
		\begin{align*}
		...
		\end{align*}
		with $a'_i,a''_i \in S_1$, $b'_i,b''_i \in S_2$ and $c'_i,c''_i \in S_3$. Thanks to \ref{lemm:properties-of-wk-in-reducible-coxeter-groups} we can assume without loss of generality that $a' \in S'_1, a'' \in S''_1$, $b' \in S'_2, b'' \in S''_2$ and $c' \in S'_3, c'' \in S''_3$.
